...
uniform vec3 uWaveColor;        // 未再生側 (#a9a9a9 DarkGray)
uniform vec3 uPlayedColor;      // 再生済側 (#66cdaa MediumAquamarine、実装名 uPlayedColor)
...
|---|---|---|
| `uWaveColor` | DarkGray `#a9a9a9` (直接指定) | 未再生側 |
| `uPlayedColor` | MediumAquamarine `#66cdaa` (直接指定) | 再生済側 |
